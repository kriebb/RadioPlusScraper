...
namespace Uncas.Web
{
    ...
    public class Feed
    {
        ...
        public void WriteRSS(Stream rs)
        {
            ...
            using (XmlTextWriter writer = new XmlTextWriter(rs, System.Text.Encoding.UTF8))
            {
                ...
                writer.WriteAttributeString("href", this.Link);
                ...
                if (this.NumberOfEnclosures > 0)
                {
                    ...
                    writer.WriteElementString("itunes:subtitle", this.Description.Substring(0,255));
                    else
                    {
        ...
        public void WriteAtom(string path)
        {
                ...
                (path, System.Text.Encoding.UTF8))
            {
                ...
                writer.WriteElementString("id", this.Link);
