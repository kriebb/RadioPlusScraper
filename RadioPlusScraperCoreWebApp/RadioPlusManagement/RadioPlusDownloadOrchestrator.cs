...
namespace RadioPlusScraperWebApi
{
    public class RadioPlusDownloadOrchestrator : IRadioPlusDownloadOrchestrator
    {
        ...
        public void Start()
        {
            ...
            backGroundClient.ContinueWith(stopDockerJobId, () => DoScheduleJob(backGroundClient), new EnqueuedState(_radioPlusDownloadHandler.NextTimeSpan.ToString().Replace(":","_")));
        }
