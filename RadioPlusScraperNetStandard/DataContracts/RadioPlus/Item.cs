...
namespace RadioPlusOnDemand.Json
{
    public class Item
    {
        ...
        [JsonProperty("stream_aac")] public string StreamAac { get; set; }

        [JsonProperty("stream_hls")] public string StreamHls { get; set; }

        [JsonProperty("stream_dash")] public string StreamDash { get; set; }
        ...
        [JsonProperty("className")] public ClassName ClassName { get; set; }
    }
}